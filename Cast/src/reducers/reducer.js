...
export const profileReducer = (state = initialStateContacts, action) => {
  switch (action.type) {

    case type.STORE_FORM_DATA:
      return Object.assign({}, state, { profileForm: action.data })
    ...
    case type.STORE_MOVIENAME:
      return Object.assign({}, state, { search: action.data })
    case type.PROFILECODE_VALIDATE_RESPONSE:
